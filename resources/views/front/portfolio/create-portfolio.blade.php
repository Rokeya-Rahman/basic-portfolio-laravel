                ...
                <div class="col-md-10 mx-auto my-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{ Form::open(['route'=>'new-portfolio', 'method'=>'POST', 'enctype'=>'multipart/form-data' ]) }}

                                <div class="form-group row">
                                    <label for="" class="col-form-label font-weight-bold col-md-3">Portfolio Title</label>
                                    <div class="col-md-9">
                                        <input type="text" name="portfolio_title" class="form-control" value="{{ old('portfolio_title') }}"/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="portfolio_description" id="editor" class="form-control" rows="8">{{ old('portfolio_description') }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="submit" class="form-control btn btn-block bg-info text-white" value="Save Portfolio Image"/>
                                    </div>
                                </div>
